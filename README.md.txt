...
A Telegram Video Compressor Bot By [𝗦𝘂𝘀𝗵𝗮𝗻𝘁𝗵 𝗕𝗼𝘁 𝗨𝗽𝗱𝗮𝘁𝗲𝘀](https://t.me/joinchat/kxhQtBfvg4Q2YzY1). **This bot works for all!** No need to define each user IDs to use bot. Also works in Group.
...
* `LOG_CHANNEL` - Put Your Bot's Logs Channel's Username. For Help ask in [Support Group](https://t.me/joinchat/kxhQtBfvg4Q2YzY1).
...
* `AUTH_USERS` - Put your ID & other Sudo Users IDs. Separate with **Space**. Just for using [Admin Commands](https://github.com/ksprojects2/VideoCompress#admin-commands).

## Optional Configs:
* `UPDATES_CHANNEL` - Put your Channel Username which you want to do Force Sub. But bot should be Admin in that channel. If got any error or not understand anything than ask in [Support Group](https://t.me/joinchat/kxhQtBfvg4Q2YzY1).
